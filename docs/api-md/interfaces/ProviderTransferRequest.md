...
Defined in: [src/providers/ProviderTransferOperations.ts:32](https://github.com/tonywied17/zero-transfer/blob/7b724e9821289c9e53b5eb587169b59a7d1172f6/src/providers/ProviderTransferOperations.ts#L32)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="attempt"></a> `attempt` | `number` | One-based attempt number. | [`TransferExecutionContext`](TransferExecutionContext.md).[`attempt`](TransferExecutionContext.md#attempt) | [src/transfers/TransferEngine.ts:30](https://github.com/tonywied17/zero-transfer/blob/7b724e9821289c9e53b5eb587169b59a7d1172f6/src/transfers/TransferEngine.ts#L30) |
...
| <a id="endpoint"></a> `endpoint` | [`TransferEndpoint`](TransferEndpoint.md) | Endpoint owned by the provider handling this request. | - | [src/providers/ProviderTransferOperations.ts:34](https://github.com/tonywied17/zero-transfer/blob/7b724e9821289c9e53b5eb587169b59a7d1172f6/src/providers/ProviderTransferOperations.ts#L34) |
...
| <a id="signal"></a> `signal?` | `AbortSignal` | Abort signal active for this execution when supplied. | [`TransferExecutionContext`](TransferExecutionContext.md).[`signal`](TransferExecutionContext.md#signal) | [src/transfers/TransferEngine.ts:32](https://github.com/tonywied17/zero-transfer/blob/7b724e9821289c9e53b5eb587169b59a7d1172f6/src/transfers/TransferEngine.ts#L32) |
