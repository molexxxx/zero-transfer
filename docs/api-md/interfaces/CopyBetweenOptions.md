...
Defined in: [src/client/operations.ts:151](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/client/operations.ts#L151)
...
| <a id="client"></a> `client` | [`TransferClient`](../classes/TransferClient.md) | Transfer client used to resolve both endpoint providers. | - | [src/client/operations.ts:153](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/client/operations.ts#L153) |
| <a id="destination"></a> `destination` | [`RemoteFileEndpoint`](RemoteFileEndpoint.md) | Destination remote endpoint. | - | [src/client/operations.ts:157](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/client/operations.ts#L157) |
...
| <a id="source"></a> `source` | [`RemoteFileEndpoint`](RemoteFileEndpoint.md) | Source remote endpoint. | - | [src/client/operations.ts:155](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/client/operations.ts#L155) |
