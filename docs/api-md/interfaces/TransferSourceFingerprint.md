...
| ------ | ------ | ------ | ------ |
| <a id="etag"></a> `etag?` | `string` | Source entity tag / unique id when the provider exposes one. | src/transfers/TransferCheckpointStore.ts:79 |
| <a id="modifiedatms"></a> `modifiedAtMs?` | `number` | Source modification time in epoch milliseconds when known. | src/transfers/TransferCheckpointStore.ts:77 |
| <a id="sizebytes"></a> `sizeBytes?` | `number` | Source size in bytes when known. | src/transfers/TransferCheckpointStore.ts:75 |
