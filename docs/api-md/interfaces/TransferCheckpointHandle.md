...
Defined in: [src/transfers/TransferCheckpointStore.ts:163](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/transfers/TransferCheckpointStore.ts#L163)
...
Defined in: [src/transfers/TransferCheckpointStore.ts:172](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/transfers/TransferCheckpointStore.ts#L172)
...
Defined in: [src/transfers/TransferCheckpointStore.ts:170](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/transfers/TransferCheckpointStore.ts#L170)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="state"></a> `state?` | `readonly` | [`TransferCheckpointState`](../type-aliases/TransferCheckpointState.md) | Validated state loaded for this transfer, when prior progress exists. `undefined` means start fresh (no checkpoint, or it was invalidated). | [src/transfers/TransferCheckpointStore.ts:168](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/transfers/TransferCheckpointStore.ts#L168) |
