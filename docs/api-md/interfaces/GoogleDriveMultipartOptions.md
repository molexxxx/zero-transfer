...
Defined in: [src/providers/cloud/GoogleDriveProvider.ts:87](https://github.com/molexxxx/zero-transfer/blob/483be946776ae5d15052263833efbd26b98c4f23/src/providers/cloud/GoogleDriveProvider.ts#L87)
...
| <a id="partsizebytes"></a> `partSizeBytes?` | `number` | Bytes per session chunk. Defaults to 8 MiB; must be a multiple of 256 KiB. | [src/providers/cloud/GoogleDriveProvider.ts:99](https://github.com/molexxxx/zero-transfer/blob/483be946776ae5d15052263833efbd26b98c4f23/src/providers/cloud/GoogleDriveProvider.ts#L99) |
| <a id="thresholdbytes"></a> `thresholdBytes?` | `number` | Payload size threshold above which a resumable session is used. Defaults to 8 MiB. | [src/providers/cloud/GoogleDriveProvider.ts:97](https://github.com/molexxxx/zero-transfer/blob/483be946776ae5d15052263833efbd26b98c4f23/src/providers/cloud/GoogleDriveProvider.ts#L97) |
