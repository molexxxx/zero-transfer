...
Defined in: [src/providers/cloud/GoogleDriveProvider.ts:87](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/providers/cloud/GoogleDriveProvider.ts#L87)
...
| <a id="partsizebytes"></a> `partSizeBytes?` | `number` | Bytes per session chunk. Defaults to 8 MiB; must be a multiple of 256 KiB. | [src/providers/cloud/GoogleDriveProvider.ts:99](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/providers/cloud/GoogleDriveProvider.ts#L99) |
| <a id="thresholdbytes"></a> `thresholdBytes?` | `number` | Payload size threshold above which a resumable session is used. Defaults to 8 MiB. | [src/providers/cloud/GoogleDriveProvider.ts:97](https://github.com/tonywied17/zero-transfer/blob/4642fef99167d4e8cbae741b0ecfe095645afa85/src/providers/cloud/GoogleDriveProvider.ts#L97) |
