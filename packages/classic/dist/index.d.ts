...
declare const SFTP_PIPELINE_DEFAULT_MAX_IN_FLIGHT = 64;
/** Default SFTP transfer chunk size in bytes (OpenSSH client default). */
declare const SFTP_PIPELINE_DEFAULT_CHUNK_BYTES = 32768;
/** Upper bound for {@link SftpPipelineOptions.chunkBytes}: 240 KiB, inside the 256 KiB packet cap. */
declare const SFTP_PIPELINE_MAX_CHUNK_BYTES = 245760;
