...
| [`SshTransportHandshakeResult`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/interfaces/SshTransportHandshakeResult.md)            | Interface | See API reference. |
| [`SshDisconnectReason`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/type-aliases/SshDisconnectReason.md)                          | Type      | See API reference. |
| [`SshAlgorithmPreferences`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/interfaces/SshAlgorithmPreferences.md)                    | Interface | See API reference. |
| [`NegotiatedSshAlgorithms`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/interfaces/NegotiatedSshAlgorithms.md)                    | Interface | See API reference. |
| [`DEFAULT_SSH_ALGORITHM_PREFERENCES`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/variables/DEFAULT_SSH_ALGORITHM_PREFERENCES.md) | Variable  | See API reference. |
| [`negotiateSshAlgorithms`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/functions/negotiateSshAlgorithms.md)                       | Function  | See API reference. |
| [`SshAuthSession`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/classes/SshAuthSession.md)                                         | Class     | See API reference. |
| [`SshPasswordCredential`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/interfaces/SshPasswordCredential.md)                        | Interface | See API reference. |
| [`SshPublickeyCredential`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/interfaces/SshPublickeyCredential.md)                      | Interface | See API reference. |
| [`SshKeyboardInteractiveCredential`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/interfaces/SshKeyboardInteractiveCredential.md)  | Interface | See API reference. |
| [`buildPublickeyCredential`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/functions/buildPublickeyCredential.md)                   | Function  | See API reference. |
| [`SshConnectionManager`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/classes/SshConnectionManager.md)                             | Class     | See API reference. |
| [`SshSessionChannel`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/classes/SshSessionChannel.md)                                   | Class     | See API reference. |
| [`SshDataReader`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/classes/SshDataReader.md)                                           | Class     | See API reference. |
| [`SshDataWriter`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/classes/SshDataWriter.md)                                           | Class     | See API reference. |
...
| [`runSshCommand`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/functions/runSshCommand.md)                                         | Function  | See API reference. |
| [`RunSshCommandOptions`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/interfaces/RunSshCommandOptions.md)                          | Interface | See API reference. |
| [`RunSshCommandResult`](https://github.com/molexxxx/zero-transfer/blob/main/docs/api-md/interfaces/RunSshCommandResult.md)                            | Interface | See API reference. |
...
- [Scope page](https://github.com/molexxxx/zero-transfer/blob/main/docs/scopes/ssh.md)
